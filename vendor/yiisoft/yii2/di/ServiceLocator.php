...
class ServiceLocator extends Component
{
    ...
    /**
     * Returns the component instance with the specified ID.    根据指定的ID返回组件实例
     *
     * @param string $id component ID (e.g. `db`).  组件ID
     * @param boolean $throwException whether to throw an exception if `$id` is not registered with the locator before.     如果ID没有在之前的进程注册，是否抛出这个异常。
     * @return object|null the component of the specified ID. If `$throwException` is false and `$id`
     * is not registered before, null will be returned.     指定ID的组件，如果$throwException为false，并且$id之前没有注册，就返回null
     * @throws InvalidConfigException if `$id` refers to a nonexistent component ID     如果$id引用一个不存在的组件ID，抛出不合法配置异常
     * @see has()
     * @see set()
     */
